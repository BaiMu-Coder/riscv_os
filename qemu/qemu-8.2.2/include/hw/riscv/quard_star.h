...
enum {
    QUARD_STAR_MROM,
    QUARD_STAR_SRAM,
    QUARD_STAR_CLINT,  //内核中断，每个core一个
    QUARD_STAR_PLIC,   //外设中断控制器，所有core共用一个
    QUARD_STAR_UART0,
    QUARD_STAR_UART1,
    QUARD_STAR_UART2,
    QUARD_STAR_RTC,
...
enum {
    ...
    QUARD_STAR_UART1_IRQ = 11,  //定义了串口中断号为10
    QUARD_STAR_UART2_IRQ = 12,  //定义了串口中断号为10
    QUARD_STAR_RTC_IRQ = 13,  //定义了串口中断号为10
};
